  ...
  public Turtle()
        ...
        public override void DoNothing()
        {
            ...
            else
            {
                ...
                Health -= 10;
                Cleanness -= 10;
                Console.WriteLine("Turtle is doing nothing.");
            }
        ...
        public override void Heal()
        {
            ...
            if (StageOfLife > 0)
            {
                ...
                Entertainment -= 30;
                Energy -= 40;
                Console.WriteLine("Turtle is healing.");
            }
            else
            {
        ...
        public override void Play()
        {
            ...
            if (StageOfLife > 0)
            {
                Entertainment += 30;
                Fullness -= 25;
                Console.WriteLine("Turtle is playing.");
            }
            else
            {
        ...
        public override void Shower()
        {
            ...
            if (StageOfLife > 0)
            {
                Cleanness += 30;
                Entertainment -= 20;
                Console.WriteLine("Turtle is showering.");
            }
            else
            {
        ...
        public override void Sleep()
        {
            ...
            if (StageOfLife > 0)
            {
                Energy += 30;
                Entertainment -= 20;
                Console.WriteLine("Turtle is sleeping.");
            }
            else
            {
        ...
        public override void Train()
        {
            ...
            if (StageOfLife > 0)
            {
                Health += 20;
                Energy -= 35;
                Console.WriteLine("Turtle is training.");
            }
            else
            {
